    ...
    public partial class intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => new { x.DoctorId, x.Date, x.Time });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorNurse", x => new { x.DoctorsId, x.NursesId });
                    table.ForeignKey(
                        name: "FK_DoctorNurse_Doctors_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_DoctorNurse_Nurses_NursesId",
                        column: x => x.NursesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorsNurses", x => new { x.NurseId, x.DoctorId });
                    table.ForeignKey(
                        name: "FK_DoctorsNurses_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_DoctorsNurses_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminDoctor", x => new { x.AdminsId, x.DoctorsId });
                    table.ForeignKey(
                        name: "FK_AdminDoctor_Admins_AdminsId",
                        column: x => x.AdminsId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AdminDoctor_Doctors_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminNurse", x => new { x.AdminsId, x.NursesId });
                    table.ForeignKey(
                        name: "FK_AdminNurse_Admins_AdminsId",
                        column: x => x.AdminsId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AdminNurse_Nurses_NursesId",
                        column: x => x.NursesId,
                        principalTable: "Nurses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminDoctor_DoctorsId",
                table: "AdminDoctor",
                column: "DoctorsId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminNurse_NursesId",
                table: "AdminNurse",
                column: "NursesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorsNurses_DoctorId",
                table: "DoctorsNurses",
                column: "DoctorId");
